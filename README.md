...
<html lang="en">
  <head>
    ...
    <title>Next Earth &mdash; Blockchain Metaverse Project</title>
  </head>
  <body>
    <div class="container">
      <div class="navigation-small">
        <div class="nav-bar">
          <input class="nav-bar-input" id="small-nav-bar" type="checkbox">
          <label class="nav-bar-label" for="small-nav-bar">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon" aria-hidden="true"><path d="M0 0h24v24H0z" fill="none"></path><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
          </label>
        </div>
        <div class="map-bar"><svg
          viewBox="0 0 24 24"
        ...
        >
          ...
          ></path></svg
      >
      <span class="map-bar-text">map</span></div>
      </div>
      <nav class="navigation">
        <div class="sidebar">
          <div class="nav-header">
            ...
            >
              <path
                d="M27.3116 4.68837C21.0605 -1.56279 10.9395 -1.56279 4.68837 4.68837C-1.56279 10.9395 -1.56279 21.0605 4.68837 27.3116C10.9395 33.5628 21.0605 33.5628 27.3116 27.3116C33.5628 21.0605 33.5628 10.9395 27.3116 4.68837ZM25.398 25.5681C22.8465 27.9495 16.6379 25.6957 11.4924 20.5502C6.34684 15.4047 4.09302 8.98339 6.55947 6.51694C9.06844 3.96545 12.4704 2.60465 16.0425 2.60465C19.6146 2.60465 22.9741 4.00797 25.5256 6.51694C30.7136 11.705 30.7561 20.1674 25.5681 25.398L25.4831 25.5256C25.4405 25.5256 25.4405 25.5256 25.398 25.5681Z"
              ></path>
            </svg>
          </div>
          ...
          <div class="main-components">
            ...
            <div class="main-card">
              ...
              <div class="map-text-box">
                ...
                <div class="icon-illustration-box">
